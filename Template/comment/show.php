    ...
    <div class="comment-content">
        <div class="markdown">
            <?php
                ...
                $comment_modified = $this->text->markdown($comment['comment'], isset($is_public) && $is_public);
                $comment_modified = $this->helper->commentModifierHelper->replaceAudioURLsWithPlayer($comment_modified);
                $comment_modified = $this->helper->commentModifierHelper->replaceVideoURLsWithPlayer($comment_modified);
